    ...
    if ($password !== $confirmPassword) {
        ...
        try {
            ...
            if ($existingUser) {
                ...
                header("Refresh: 2; url=dangnhap.php"); // Redirect to login page after 2 seconds
                exit;
            }
    ...
    <div class="container">
        ...
        <div class="form-container">
            <div class="form-header">
                <a href="dangky.php" class="form-header-link active">Sign Up</a>
                <a href="dangnhap.php" class="form-header-link">Login</a>
            </div>
